...
GO
CREATE TRIGGER [dbo].[trig_brcledger_create] on [dbo].[brcledger] 
...
BEGIN
	...
	begin
		exec dbo.bdxManagement @Branch, @PK, @ClientRef, @PolicyId,@Suffix, @PolicyType, @TransType, @DateRaised, 'Create';
